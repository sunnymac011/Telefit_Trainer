...
public class MultiSelectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MultiSelectAdapter(Context context, RecyclerView recyclerView) {
...
//            progressBar = (ProgressBar) view.findViewById(R.id.progressBar1);
    ...
    public ArrayList<SubExerciseBean> getSelected() {
        ArrayList<SubExerciseBean> selected = new ArrayList<>();
