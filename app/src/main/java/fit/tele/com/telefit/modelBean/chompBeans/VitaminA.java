...
public class VitaminA implements Parcelable {
    ...
    public static final Creator<VitaminA> CREATOR = new Creator<VitaminA>() {
        @Override
        public VitaminA createFromParcel(Parcel in) {
            return new VitaminA(in);
        }

        @Override
        public VitaminA[] newArray(int size) {
            return new VitaminA[size];
        }
    };
