...
public class SaturatedFat implements Parcelable {
    ...
    public static final Creator<SaturatedFat> CREATOR = new Creator<SaturatedFat>() {
        @Override
        public SaturatedFat createFromParcel(Parcel in) {
            return new SaturatedFat(in);
        }

        @Override
        public SaturatedFat[] newArray(int size) {
            return new SaturatedFat[size];
        }
    };
